...
### README
# this script runs all of our 1st experiment using WEKA
...
# # training features
# if test -f ./data/train.arff; then
#     train_set=./data/train.arff
# else
...
# # test features
# if test -f ./data/test.arff; then
#     test_set=./data/test.arff
# else
...
# dev features
if test -f ./data/dev.arff; then
    train_set=./data/dev.arff
else
    echo "training data not found"
    exit -1
fi
...
###################
# Task 1: Correlation title<->score
###################

echo "Task 1 Correlation title<->score"
task=TITLE
# choose appropriate target feature
target=2
# ignore all but the title
ignore_list=1,3,5,6,7,8,9,10
...
###################
# Subtask 1 of 2: trigrams no stemmer
###################

echo "Subtask 1 of 2: trigrams no stemmer"
...
echo "Task 1 of 3, representation 1 of 2 finished. Results in $sub_task_dir \n"
